package com.osttra.trade_matching.matchAlgo;
...
import com.osttra.trade_matching.repository.MatchRepository;
import com.osttra.trade_matching.repository.TradeRepository;
import com.osttra.trade_matching.services.MatchInterfaceService;
import com.osttra.trade_matching.services.MatchService;
...
//	MatchRepository matchRepo;
	...
	public int calculateMatchingScore(TradeData tradeA,TradeData cpTrade) {
		...
		if(tradeA.getEffetiveDate().equals(cpTrade.getEffetiveDate())) {percent+= effDatePercent;System.out.println("4-Effective data Matched");}
